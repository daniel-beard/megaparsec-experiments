...
/* package megaparsec-recovery-0.1.0.0 */
#define VERSION_megaparsec_recovery "0.1.0.0"
#define MIN_VERSION_megaparsec_recovery(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
/* package scientific-0.3.4.12 */
#define VERSION_scientific "0.3.4.12"
...
#define CURRENT_COMPONENT_ID "megaparsec-recovery-0.1.0.0-BOAQogFlhCzFOlVcmCNBBx"

#define CURRENT_PACKAGE_KEY "megaparsec-recovery-0.1.0.0-BOAQogFlhCzFOlVcmCNBBx"
